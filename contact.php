                    ...
                    <div class="row">
                         <div class="col-xl-5 col-lg-6 text-white">
                              ...
                              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus
                                   mauris scelerisque, at rutrum nulla dictum.</p>
                         </div>
                    </div>
               </div>
          </div>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                         ...
                         <p>Odio ultrices ut. Etiam ac erat ut enim maximus accumsan vel ac nisl. Duis feug iat bibendum
                              orci, non elementum urna. Cras sit amet sapien aliquam.</p>
                         <div class="row">
                              <div class="col-md-9">
                                   <ul class="contact-info-list">
                                        ...
                                        <li>
                                             ...
                                             <div class="cf-right">aachcoder96@gmail.com</div>
                                        </li>
                                   </ul>
                              </div>
                         </div>
                         <div class="social-links">
                              ...
                              <a href="https://discord.gg/E7aNYy8y" target="_blank"><i>
